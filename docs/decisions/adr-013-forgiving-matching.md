...
## Decision
Match typed answers with NFD diacritic folding and per-item accepted-variant sets, returning a verdict of correct, almost, or wrong, rather than building a full words-to-number parser.
