// Golden reference: canonical es-ES spelling for every integer 0..1000.
// Hand-authored from docs/architecture/spanish-number-rules.md as the
// independent verification anchor for numberToWords — never derive it
// from the engine under test.
export const GOLDEN_0_1000: readonly string[] = [
  'cero', // 0
  'uno', // 1
  'dos', // 2
  'tres', // 3
  ...
  'setecientos veintidós', // 722
  'setecientos veintitrés', // 723
  ...
  'ochocientos veintidós', // 822
  'ochocientos veintitrés', // 823
  'ochocientos veinticuatro', // 824
  'ochocientos veinticinco', // 825
  'ochocientos veintiséis', // 826
  ...
  'novecientos veintidós', // 922
  'novecientos veintitrés', // 923
  'novecientos veinticuatro', // 924
  'novecientos veinticinco', // 925
  'novecientos veintiséis', // 926
